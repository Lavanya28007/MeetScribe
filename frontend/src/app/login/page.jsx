...
const loginForm = useFormik({ 
  ...
  return (
  <div className="min-h-screen mx-auto max-w-md mt-7 bg-base border border-gray-200 rounded-xl shadow-2xs">
        ...
        <div className="mt-5">
          ...
          <form onSubmit={loginForm.handleSubmit}>
            <div className="grid gap-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 px-4 rounded-lg bg-primary text-white font-medium hover:bg-[#fb6e2dd9]"
              >
                Sign in
              </button>
